...
const GRADIENT_COLORS = [
  'from-orange-500/10 to-blue-500/5',
  ...
  'from-pink-500/10 to-orange-500/5',
];
  ...
  return (
    <motion.div
      className={classNames(
        ...
        gradientClass,
        borderEffect
          ? 'border border-bolt-elements-borderColor dark:border-bolt-elements-borderColor-dark hover:border-orange-500/40'
          : '',
