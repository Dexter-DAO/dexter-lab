        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          <div className="p-4 space-y-3">
            <div className="flex gap-2">
              <a
                href="/"
                className="flex-1 flex gap-2 items-center bg-orange-50 dark:bg-orange-500/10 text-orange-700 dark:text-orange-300 hover:bg-orange-100 dark:hover:bg-orange-500/20 rounded-lg px-4 py-2 transition-colors"
              >
              ...
              <button
                ...
                className={classNames(
                  ...
                  selectionMode
                    ? 'bg-orange-600 dark:bg-orange-500 text-white border border-orange-700 dark:border-orange-600'
            ...
            <div className="relative w-full">
              ...
              <input
                className="w-full bg-gray-50 dark:bg-gray-900 relative pl-9 pr-3 py-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-orange-500/50 text-sm text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-500 border border-gray-200 dark:border-gray-800"
                type="search"
          ...
          <div className="max-h-[40vh] overflow-y-auto shrink-0 sidebar-scroll">
            <ResourceList />
          </div>
          <div className="flex items-center justify-between text-sm px-4 py-2 shrink-0">
