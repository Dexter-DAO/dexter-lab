    ...
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        ...
        >
          ...
          >
            <div className="i-ph:user-circle w-4 h-4 text-gray-400 group-hover:text-orange-500 dark:group-hover:text-orange-400 transition-colors" />
            Edit Profile
          </DropdownMenu.Item>
          ...
          >
            <div className="i-ph:gear-six w-4 h-4 text-gray-400 group-hover:text-orange-500 dark:group-hover:text-orange-400 transition-colors" />
            Settings
          </DropdownMenu.Item>
          ...
          >
            <div className="i-ph:download w-4 h-4 text-gray-400 group-hover:text-orange-500 dark:group-hover:text-orange-400 transition-colors" />
            Download Debug Log
          </DropdownMenu.Item>
          ...
          >
            <div className="i-ph:question w-4 h-4 text-gray-400 group-hover:text-orange-500 dark:group-hover:text-orange-400 transition-colors" />
            Help & Documentation
          </DropdownMenu.Item>
        </DropdownMenu.Content>
      </DropdownMenu.Portal>
