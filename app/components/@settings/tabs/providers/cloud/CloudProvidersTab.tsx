            ...
            >
              <div className="absolute top-0 right-0 p-2 flex gap-1">
                {URL_CONFIGURABLE_PROVIDERS.includes(provider.name) && (
                  <motion.span
                    className="px-2 py-0.5 text-xs rounded-full bg-orange-500/10 text-orange-500 font-medium"
              ...
              <div className="flex items-start gap-4 p-4">
                <motion.div
                  className={classNames(
                    ...
                    'transition-all duration-200',
                    provider.settings.enabled ? 'text-orange-500' : 'text-bolt-elements-textSecondary',
                  )}
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-4 mb-2">
                    <div>
                      <h4 className="text-sm font-medium text-bolt-elements-textPrimary group-hover:text-orange-500 transition-colors">
                        {provider.name}
                      </h4>
                        ...
                        {editingProvider === provider.name ? (
                          ...
                          >
                            <div className="flex items-center gap-2 text-bolt-elements-textSecondary">
                              ...
                              <span className="group-hover/url:text-orange-500 transition-colors">
              ...
              <motion.div
                className="absolute inset-0 border-2 border-orange-500/0 rounded-lg pointer-events-none"
                animate={{
