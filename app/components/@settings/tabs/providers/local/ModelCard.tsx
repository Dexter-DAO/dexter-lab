...
function ModelCard({ model, onUpdate, onDelete }: ModelCardProps) {
  return (
    <Card className="bg-bolt-elements-background-depth-3 hover:bg-bolt-elements-background-depth-4 transition-all duration-200 shadow-sm hover:shadow-md border border-bolt-elements-borderColor hover:border-orange-500/20">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={classNames(
                ...
                'bg-orange-500/10 text-orange-500 hover:bg-orange-500/20 hover:shadow-sm',
                'disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-orange-500/10',
              )}
            >
