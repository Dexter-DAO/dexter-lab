...
function SetupGuide({ onBack }: { onBack: () => void }) {
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-gradient-to-r from-blue-500/10 to-orange-500/10 border border-blue-500/20 shadow-sm">
      ...
      <Card className="bg-bolt-elements-background-depth-2 shadow-sm">
        <CardHeader className="pb-6">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-orange-500/20 to-orange-600/20 flex items-center justify-center ring-1 ring-orange-500/30">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-3 rounded-lg bg-bolt-elements-background-depth-3">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="w-full bg-gradient-to-r from-orange-500/10 to-orange-600/10 hover:from-orange-500/20 hover:to-orange-600/20 border-orange-500/30 hover:border-orange-500/50 transition-all duration-300 gap-2 group shadow-sm hover:shadow-lg hover:shadow-orange-500/20 font-medium"
                    _asChild
                  >
                    <a
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-orange-500/5 border border-orange-500/20">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-medium text-orange-500">Performance Optimized</span>
                </div>
      ...
      <Card className="bg-gradient-to-r from-orange-500/10 to-pink-500/10 border border-orange-500/20 shadow-sm">
