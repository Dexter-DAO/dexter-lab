      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-orange-500/20 to-blue-500/20 flex items-center justify-center ring-1 ring-orange-500/30">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="bg-bolt-elements-background-depth-2 hover:bg-bolt-elements-background-depth-3 border-bolt-elements-borderColor hover:border-orange-500/30 transition-all duration-200 gap-2"
              >
                    ...
                    {isLoadingModels ? (
                      ...
                      <div className="text-center py-8">
                        ...
                        <Button
                          variant="outline"
                          size="sm"
                          className="bg-gradient-to-r from-orange-500/8 to-orange-600/8 hover:from-orange-500/15 hover:to-orange-600/15 border-orange-500/25 hover:border-orange-500/40 transition-all duration-300 gap-2 group shadow-sm hover:shadow-md font-medium"
                          _asChild
                        >
                          <a
                            href="https://ollama.com/library"
