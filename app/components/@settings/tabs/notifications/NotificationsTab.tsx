...
const NotificationsTab = () => {
  ...
  const filterOptions: { id: FilterType; label: string; icon: string; color: string }[] = [
    { id: 'all', label: 'All Notifications', icon: 'i-ph:bell', color: '#F26B1A' },
    { id: 'system', label: 'System', icon: 'i-ph:gear', color: '#6b7280' },
    { id: 'update', label: 'Updates', icon: 'i-ph:arrow-circle-up', color: '#F26B1A' },
  ...
  return (
    <div className="flex h-full flex-col gap-6">
      <div className="flex items-center justify-between">
        ...
        >
          <span className="i-ph:trash text-lg text-gray-500 dark:text-gray-400 group-hover:text-orange-500 transition-colors" />
          Clear All
        </button>
      </div>
