            ...
            {log.details && (
              <>
                <button
                  ...
                  className="text-xs text-gray-500 dark:text-gray-400 hover:text-orange-500 dark:hover:text-orange-400 transition-colors"
                >
  ...
  const ExportButton = () => {
    ...
    return (
      <DialogRoot open={isOpen} onOpenChange={handleOpenChange}>
        ...
        >
          <span className="i-ph:download text-lg text-gray-500 dark:text-gray-400 group-hover:text-orange-500 transition-colors" />
          Export
        </button>
    ...
    <div className="flex h-full flex-col gap-6">
      <div className="flex items-center justify-between">
          ...
          <DropdownMenu.Portal>
            ...
            >
              {logLevelOptions.map((option) => (
                <DropdownMenu.Item
                  key={option.value}
                  className="group flex items-center px-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-orange-500/10 dark:hover:bg-orange-500/20 cursor-pointer transition-colors"
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <span className="i-ph:arrows-clockwise text-lg text-gray-500 dark:text-gray-400 group-hover:text-orange-500 transition-colors" />
            Refresh
          </button>
