...
┌─────────────────────────────────────────────┐
│                 Dexter Lab UI                │
│         (Remix/React, WebContainer)          │
├─────────────────────────────────────────────┤
│            Claude Agent SDK                  │
│   (Stateful sessions, MCP tools, Skills)     │
├─────────────────────────────────────────────┤
│           Deploy Pipeline                    │
│   Docker → Traefik → *.resources.dexter.cash │
├─────────────────────────────────────────────┤
│          x402 Settlement Layer               │
│   @dexterai/x402 SDK → Solana USDC          │
├─────────────────────────────────────────────┤
│         ERC-8004 Identity Layer              │
│   Auto-mint → Reputation → Marketplace       │
├─────────────────────────────────────────────┤
│          Revenue Engine                      │
│   Earnings → Payouts → $DEXTER Buyback       │
└─────────────────────────────────────────────┘
```
